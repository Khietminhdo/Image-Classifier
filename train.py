...
trainloader, v_loader, testloader = ipynb.load_data(where)


model, optimizer, criterion = ipynb.nn_setup(structure,dropout,hidden_layer1,lr,power)


ipynb.train_network(model, optimizer, criterion, epochs, 20, trainloader, power)
